"""
This is a copy of BR_rVE_RTformat.py from the external folder. It is used for testing
...
def analyze_v2(chest_raw, fs, hw_v, max_amp, baseline, fev1, chest_vis = False):
    '''
    ...
    if np.all((chest_raw == 0)):
        ...
        # To analyze the filtering methods used in the post-processing algorithm
        if chest_vis:
            return chest_bs_smooth
